---
title: About QuantOmics
summary: About the NSERC CREATE QuantOmics program
date: 2025-01-01
...
- **Quantum Nanotechnology** — enabling detection at the attomolar level, capturing molecular events invisible to conventional sensors
- **Computational Genomics** — converting sensor data into actionable multi-omic insights
- **Artificial Intelligence** — building predictive models that guide rational therapeutic design
...
## What Makes QuantOmics Innovative?

1. **Integrated Research Pipeline** — The three streams are structurally interdependent. An engineer in Stream 1 cannot validate their sensor without a biologist in Stream 2, and neither can succeed without a data scientist in Stream 3. This forces deep functional collaboration rarely seen in graduate training.

2. **Translational Trajectory Mentorship Trio** — Every graduate trainee is supported by a primary supervisor, a co-supervisor from a complementary stream, and an industry advisor — guaranteeing interdisciplinary perspective from day one.

3. **Accessible and Inclusive** — Open to HQP from Electrical and Computer Engineering, Physics, Computer Science, Computational Biology, Molecular Genetics, and Genomic Medicine. No prior knowledge in the other fields is required.

4. **Real-World Validation** — Trainee research is validated using patient-derived organoid and organ-on-a-chip platforms, providing physiologically relevant models that more accurately predict human clinical response than traditional 2D cell cultures.

5. **Whole-of-Society Approach** — Industry partners such as C2MI and Epiloid Biotech provide access to quantum infrastructure and organoid setups that are otherwise inaccessible to most Canadian universities.

6. **EDI Embedded at Every Level** — Equity, Diversity, and Inclusion is treated as a core component of scientific excellence, not a box-checking exercise.

---

## Career Pathways for QuantOmics Graduates
...
- **Biotech & Pharma** — Roles in R&D, diagnostics, bioinformatics, and precision medicine at companies driving the quantum-biomedical economy
- **Medical Devices & Deep Tech** — Positions at companies developing next-generation biosensors, point-of-care diagnostics, and quantum technology platforms
- **Academic & Research Institutions** — Faculty and research scientist positions at universities and institutes such as SickKids, NRC, and TFRI
- **Government & Regulatory Bodies** — Roles at Health Canada, ISED Canada, and provincial genomics organizations such as Ontario Genomics
...
- **Yan Fossat** — SVP, Digital Health R&D, Klick Health
- **Dax Torti** — Senior Clinical Project Manager, Precision Medicine, Alimentiv
- **Bruce Seet** — Head of Medical Affairs, Novavax
- **Mark Aquilino** — CEO, Epiloid Biotech
- **Anna Blakney** — Professor, Biomedical Engineering, UBC
